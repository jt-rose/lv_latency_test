defmodule LvLatencyTestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LvLatencyTestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LvLatencyTestWeb.Gettext, "errors", msg, opts)
    end
  end
